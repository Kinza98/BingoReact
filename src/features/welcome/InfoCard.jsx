...
function InfoCard() {
  return (
    <ol className="bg-white/10 hyphens-auto sm:py-8 py-6 md:py-10 pl-4 pr-5 sm:px-8 md:px-10 border-[rgba(255,255,255,0.15)] text-justify border-2 rounded-xl shadow-xl text-slate-200 my-3 sm:my-5 md:my-7 md:text-lg max-w-175 font-secondary space-y-2">
