  ...
  return (
    <div className="relative w-full">
      <input
        ...
        id={id}
        className="peer w-full px-3 sm:px-4 py-2  sm:py-3 md:text-lg text-base rounded-lg bg-white/10 border border-white/10 outline-none text-white placeholder:text-white/50 font-secondary focus:border-amber transition-all duration-200"
      />
        ...
        className={`
          ...
          ${
            floating
              ...
              : "top-1/2 -translate-y-1/2 text-[0.975rem] sm:text-base md:text-lg text-white/50"
          }
        `}
      >
        {label}
